...
const loginSchema = Yup.object().shape({
  ...
  password: Yup.string().required().min(6, "Should more than 6 characters"),
  ...
  return (
    <Form noValidate onSubmit={props.handleSubmit}>
      ...
      <InputGroup className="mb-5">
        <InputGroup.Text id="basic-addon1" className="inp-logo">
          <FiMail className="color-A9A9A999 fs-22px" />
        </InputGroup.Text>
        <Form.Control
          type="text"
          name="email"
      ...
      <InputGroup className="mb-3">
        <InputGroup.Text id="basic-addon1" className="inp-logo">
          <FiLock className="color-A9A9A999 fs-22px" />
        </InputGroup.Text>
        <Form.Control
        ...
        >
          {open ? (
            <FiEye className="color-A9A9A999 fs-22px" />
          ) : (
            <FiEyeOff className="color-A9A9A999 fs-22px" />
          )}
        </InputGroup.Text>
        <Form.Control.Feedback type="invalid">
      ...
      <Stack direction="horizontal" gap={3}>
        <div className="ms-auto mt-3 pb-5">
          <Link className="a-menu fs-14px fw-600" to={"/reset-password"}>
            Forgot password?
          </Link>
        </div>
      </Stack>
        ...
        <Row>
          ...
          <Col md={5}>
            <Row className="mx-4">
              <Col md={10}>
                <div>
                  <h1 className="martop-120px fs-24px fw-700 line-height-32px color-3A3D42">
                    Start Accessing Banking Needs
                    <br />
                    With All Devices and All Platforms With 30.000+ Users
                  </h1>
                </div>
                <div>
                ...
                <div className="mt-5">
                  ...
                  <div className="form-check form-check-reverse position-relative text-center my-5">
                    <label className="form-check-label">
                      ...
                      <Link className="have-signup" to={"/sign-up"}>
                        Sign Up
                      </Link>
                    </label>
                  </div>
